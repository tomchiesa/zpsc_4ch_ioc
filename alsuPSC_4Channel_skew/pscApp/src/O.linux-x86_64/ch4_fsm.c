/* C code for program ch4_fsm, generated by snc from ../ch4_fsm.st */
#include <string.h>
#include <stddef.h>
#include <stdio.h>
#include <limits.h>
...
# line 17 "../ch4_fsm.st"
	short ch4_mode;
# line 18 "../ch4_fsm.st"
	short ch4_ps_on_off_sts;
# line 21 "../ch4_fsm.st"
	short ch4_dac_rdbck;
# line 22 "../ch4_fsm.st"
	short ch4_ps_sts;
# line 25 "../ch4_fsm.st"
	string Chan4_seq_messages;
};
...
# line 34 "../ch4_fsm.st"
			seqg_var->ch4_mode = 0;
# line 35 "../ch4_fsm.st"
			seq_pvPutTmo(seqg_env, 5/*ch4_mode*/, DEFAULT, DEFAULT_TIMEOUT);
# line 36 "../ch4_fsm.st"
			sprintf(seqg_var->Chan4_seq_messages, "PS OFF");
# line 37 "../ch4_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan4_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
# line 38 "../ch4_fsm.st"
			seqg_var->ch4_ps_on_off_sts = 1;
# line 39 "../ch4_fsm.st"
			seq_pvPutTmo(seqg_env, 6/*ch4_ps_on_off_sts*/, DEFAULT, DEFAULT_TIMEOUT);
		}
		return;
	}
}
...
# line 45 "../ch4_fsm.st"
			seq_pvPutTmo(seqg_env, 0/*Park*/, DEFAULT, DEFAULT_TIMEOUT);
# line 46 "../ch4_fsm.st"
			seqg_var->ch4_ps_on_off_sts = 0;
# line 47 "../ch4_fsm.st"
			seq_pvPutTmo(seqg_env, 6/*ch4_ps_on_off_sts*/, DEFAULT, DEFAULT_TIMEOUT);
# line 48 "../ch4_fsm.st"
			sprintf(seqg_var->Chan4_seq_messages, "Zero DAC");
# line 49 "../ch4_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan4_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
# line 50 "../ch4_fsm.st"
			seqg_var->ch4_dac_setpoint = 0.0;
# line 51 "../ch4_fsm.st"
			seq_pvPutTmo(seqg_env, 2/*ch4_dac_setpoint*/, DEFAULT, DEFAULT_TIMEOUT);
		}
		return;
	}
}
...
{
# line 60 "../ch4_fsm.st"
	if ((seqg_var->ch4_dac_rdbck < 0.01) && (seqg_var->ch4_dac_rdbck > -0.01))
	{
		*seqg_pnst = 4;
		*seqg_ptrn = 0;
		return TRUE;
...
# line 62 "../ch4_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan4_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
# line 63 "../ch4_fsm.st"
			seqg_var->ch4_dac_setpoint = 0.000;
# line 64 "../ch4_fsm.st"
			seq_pvPutTmo(seqg_env, 2/*ch4_dac_setpoint*/, DEFAULT, DEFAULT_TIMEOUT);
		}
		return;
...
# line 72 "../ch4_fsm.st"
			seq_pvPutTmo(seqg_env, 5/*ch4_mode*/, DEFAULT, DEFAULT_TIMEOUT);
# line 73 "../ch4_fsm.st"
			sprintf(seqg_var->Chan4_seq_messages, "Pwr ON");
# line 74 "../ch4_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan4_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
# line 75 "../ch4_fsm.st"
			seqg_var->on1_cmd = 1;
...
static void seqg_action_OFF_ON_FSM_0_CLEAR_FAULTS(SS_ID seqg_env, int seqg_trn, int *seqg_pnst)
{
	...
	case 0:
		{
# line 81 "../ch4_fsm.st"
			sprintf(seqg_var->Chan4_seq_messages, "Clr Faults");
# line 82 "../ch4_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan4_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
# line 83 "../ch4_fsm.st"
			seqg_var->ch4_clr_flts = 1;
# line 84 "../ch4_fsm.st"
			seq_pvPutTmo(seqg_env, 4/*ch4_clr_flts*/, DEFAULT, DEFAULT_TIMEOUT);
		}
		return;
	}
}
...
static void seqg_action_OFF_ON_FSM_0_WAIT_TO_CLEAR(SS_ID seqg_env, int seqg_trn, int *seqg_pnst)
{
	...
	case 0:
		{
# line 89 "../ch4_fsm.st"
			sprintf(seqg_var->Chan4_seq_messages, "Clearing");
# line 90 "../ch4_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan4_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
# line 91 "../ch4_fsm.st"
			seqg_var->ch4_clr_flts = 0;
# line 92 "../ch4_fsm.st"
			seq_pvPutTmo(seqg_env, 4/*ch4_clr_flts*/, DEFAULT, DEFAULT_TIMEOUT);
		}
		return;
...
static void seqg_action_OFF_ON_FSM_0_PARK_OFF(SS_ID seqg_env, int seqg_trn, int *seqg_pnst)
{
	...
	case 0:
		{
# line 97 "../ch4_fsm.st"
			sprintf(seqg_var->Chan4_seq_messages, "Park OFF");
# line 98 "../ch4_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan4_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
# line 99 "../ch4_fsm.st"
			seqg_var->Park = 0;
...
static void seqg_action_OFF_ON_FSM_0_DONE_CHECK(SS_ID seqg_env, int seqg_trn, int *seqg_pnst)
{
	...
	case 0:
		{
# line 105 "../ch4_fsm.st"
			sprintf(seqg_var->Chan4_seq_messages, "FAULTED");
# line 106 "../ch4_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan4_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
# line 107 "../ch4_fsm.st"
			seqg_var->ch4_ps_on_off_sts = 1;
...
# line 117 "../ch4_fsm.st"
			seq_pvPutTmo(seqg_env, 6/*ch4_ps_on_off_sts*/, DEFAULT, DEFAULT_TIMEOUT);
# line 118 "../ch4_fsm.st"
			sprintf(seqg_var->Chan4_seq_messages, "Try Again");
# line 119 "../ch4_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan4_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
		}
		return;
...
static void seqg_action_OFF_ON_FSM_0_DONE(SS_ID seqg_env, int seqg_trn, int *seqg_pnst)
{
	...
	case 0:
		{
# line 124 "../ch4_fsm.st"
			sprintf(seqg_var->Chan4_seq_messages, "PS Ready");
# line 125 "../ch4_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan4_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
# line 126 "../ch4_fsm.st"
			seqg_var->ch4_ps_on_off_sts = 1;
...
# line 134 "../ch4_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan4_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
# line 135 "../ch4_fsm.st"
			seqg_var->ch4_dac_setpoint = 0.00;
# line 136 "../ch4_fsm.st"
			seq_pvPutTmo(seqg_env, 2/*ch4_dac_setpoint*/, DEFAULT, DEFAULT_TIMEOUT);
# line 137 "../ch4_fsm.st"
			seqg_var->ch4_ps_on_off_sts = 0;
...
static void seqg_action_OFF_ON_FSM_0_SET_DAC_TO_ZERO_OFF(SS_ID seqg_env, int seqg_trn, int *seqg_pnst)
{
	...
	case 0:
		{
# line 148 "../ch4_fsm.st"
			sprintf(seqg_var->Chan4_seq_messages, "Pls Wait");
# line 149 "../ch4_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan4_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
		}
		return;
...
static void seqg_action_OFF_ON_FSM_0_POWER_OFF(SS_ID seqg_env, int seqg_trn, int *seqg_pnst)
{
	...
	case 0:
		{
# line 154 "../ch4_fsm.st"
			sprintf(seqg_var->Chan4_seq_messages, "Pwr OFF");
# line 155 "../ch4_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan4_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
# line 156 "../ch4_fsm.st"
			seqg_var->on1_cmd = 0;
...
static seqChan seqg_chans[] = {
	...
	{"{M1}I-sp", offsetof(struct seqg_vars, ch4_dac_setpoint), "ch4_dac_setpoint", P_SHORT, 1, 3, 0, 1, 0, 0},
	{"{M0}:On1-Cmd", offsetof(struct seqg_vars, on1_cmd), "on1_cmd", P_SHORT, 1, 4, 0, 1, 0, 0},
	{"{M2}FltClearChan4-bo", offsetof(struct seqg_vars, ch4_clr_flts), "ch4_clr_flts", P_SHORT, 1, 5, 0, 1, 0, 0},
	{"{M1}Mode-cmd", offsetof(struct seqg_vars, ch4_mode), "ch4_mode", P_SHORT, 1, 6, 0, 1, 0, 0},
	{"{M0}:PsOnOff-Sts", offsetof(struct seqg_vars, ch4_ps_on_off_sts), "ch4_ps_on_off_sts", P_SHORT, 1, 7, 0, 1, 0, 0},
	{"{M0}-DAC-SP", offsetof(struct seqg_vars, ch4_dac_rdbck), "ch4_dac_rdbck", P_SHORT, 1, 8, 0, 1, 0, 0},
	{"{M0}:Status0", offsetof(struct seqg_vars, ch4_ps_sts), "ch4_ps_sts", P_SHORT, 1, 9, 0, 1, 0, 0},
	{"Chan4_seq_messages", offsetof(struct seqg_vars, Chan4_seq_messages), "Chan4_seq_messages", P_STRING, 1, 10, 0, 0, 0, 0},
};
...
seqProgram ch4_fsm = {
	...
	/* program name */      "ch4_fsm",
	/* channels */          seqg_chans,
	/* num. channels */     10,
	/* state sets */        seqg_statesets,
	/* num. state sets */   1,
	/* user var size */     sizeof(struct seqg_vars),
	/* param */             "M0=SR:C04-MG{zPSC1}Chan4,M1=SR:C04-MG{zPSC1:Chan4}, M2=SR:C04-MG{zPSC1}",
	/* num. event flags */  0,
...
static void ch4_fsmRegistrar (void) {
    seqRegisterSequencerCommands();
    seqRegisterSequencerProgram (&ch4_fsm);
}
epicsExportRegistrar(ch4_fsmRegistrar);
