/* C code for program ch2_fsm, generated by snc from ../ch2_fsm.st */
#include <string.h>
#include <stddef.h>
#include <stdio.h>
#include <limits.h>
...
# line 17 "../ch2_fsm.st"
	short ch2_mode;
# line 18 "../ch2_fsm.st"
	short ch2_ps_on_off_sts;
# line 21 "../ch2_fsm.st"
	short ch2_dac_rdbck;
# line 22 "../ch2_fsm.st"
	short ch2_ps_sts;
# line 25 "../ch2_fsm.st"
	string Chan2_seq_messages;
};
...
# line 34 "../ch2_fsm.st"
			seqg_var->ch2_mode = 0;
# line 35 "../ch2_fsm.st"
			seq_pvPutTmo(seqg_env, 5/*ch2_mode*/, DEFAULT, DEFAULT_TIMEOUT);
# line 36 "../ch2_fsm.st"
			sprintf(seqg_var->Chan2_seq_messages, "PS OFF");
# line 37 "../ch2_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan2_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
# line 38 "../ch2_fsm.st"
			seqg_var->ch2_ps_on_off_sts = 1;
# line 39 "../ch2_fsm.st"
			seq_pvPutTmo(seqg_env, 6/*ch2_ps_on_off_sts*/, DEFAULT, DEFAULT_TIMEOUT);
		}
		return;
	}
}
...
# line 45 "../ch2_fsm.st"
			seq_pvPutTmo(seqg_env, 0/*Park*/, DEFAULT, DEFAULT_TIMEOUT);
# line 46 "../ch2_fsm.st"
			seqg_var->ch2_ps_on_off_sts = 0;
# line 47 "../ch2_fsm.st"
			seq_pvPutTmo(seqg_env, 6/*ch2_ps_on_off_sts*/, DEFAULT, DEFAULT_TIMEOUT);
# line 48 "../ch2_fsm.st"
			sprintf(seqg_var->Chan2_seq_messages, "Zero DAC");
# line 49 "../ch2_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan2_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
# line 50 "../ch2_fsm.st"
			seqg_var->ch2_dac_setpoint = 0.0;
# line 51 "../ch2_fsm.st"
			seq_pvPutTmo(seqg_env, 2/*ch2_dac_setpoint*/, DEFAULT, DEFAULT_TIMEOUT);
		}
		return;
	}
}
...
{
# line 60 "../ch2_fsm.st"
	if ((seqg_var->ch2_dac_rdbck < 0.01) && (seqg_var->ch2_dac_rdbck > -0.01))
	{
		*seqg_pnst = 4;
		*seqg_ptrn = 0;
		return TRUE;
...
# line 62 "../ch2_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan2_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
# line 63 "../ch2_fsm.st"
			seqg_var->ch2_dac_setpoint = 0.000;
# line 64 "../ch2_fsm.st"
			seq_pvPutTmo(seqg_env, 2/*ch2_dac_setpoint*/, DEFAULT, DEFAULT_TIMEOUT);
		}
		return;
...
# line 72 "../ch2_fsm.st"
			seq_pvPutTmo(seqg_env, 5/*ch2_mode*/, DEFAULT, DEFAULT_TIMEOUT);
# line 73 "../ch2_fsm.st"
			sprintf(seqg_var->Chan2_seq_messages, "Pwr ON");
# line 74 "../ch2_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan2_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
# line 75 "../ch2_fsm.st"
			seqg_var->on1_cmd = 1;
...
static void seqg_action_OFF_ON_FSM_0_CLEAR_FAULTS(SS_ID seqg_env, int seqg_trn, int *seqg_pnst)
{
	...
	case 0:
		{
# line 81 "../ch2_fsm.st"
			sprintf(seqg_var->Chan2_seq_messages, "Clr Faults");
# line 82 "../ch2_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan2_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
# line 83 "../ch2_fsm.st"
			seqg_var->ch2_clr_flts = 1;
# line 84 "../ch2_fsm.st"
			seq_pvPutTmo(seqg_env, 4/*ch2_clr_flts*/, DEFAULT, DEFAULT_TIMEOUT);
		}
		return;
	}
}
...
static void seqg_action_OFF_ON_FSM_0_WAIT_TO_CLEAR(SS_ID seqg_env, int seqg_trn, int *seqg_pnst)
{
	...
	case 0:
		{
# line 89 "../ch2_fsm.st"
			sprintf(seqg_var->Chan2_seq_messages, "Clearing");
# line 90 "../ch2_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan2_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
# line 91 "../ch2_fsm.st"
			seqg_var->ch2_clr_flts = 0;
# line 92 "../ch2_fsm.st"
			seq_pvPutTmo(seqg_env, 4/*ch2_clr_flts*/, DEFAULT, DEFAULT_TIMEOUT);
		}
		return;
...
static void seqg_action_OFF_ON_FSM_0_PARK_OFF(SS_ID seqg_env, int seqg_trn, int *seqg_pnst)
{
	...
	case 0:
		{
# line 97 "../ch2_fsm.st"
			sprintf(seqg_var->Chan2_seq_messages, "Park OFF");
# line 98 "../ch2_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan2_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
# line 99 "../ch2_fsm.st"
			seqg_var->Park = 0;
...
static void seqg_action_OFF_ON_FSM_0_DONE_CHECK(SS_ID seqg_env, int seqg_trn, int *seqg_pnst)
{
	...
	case 0:
		{
# line 105 "../ch2_fsm.st"
			sprintf(seqg_var->Chan2_seq_messages, "FAULTED");
# line 106 "../ch2_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan2_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
# line 107 "../ch2_fsm.st"
			seqg_var->ch2_ps_on_off_sts = 1;
...
# line 117 "../ch2_fsm.st"
			seq_pvPutTmo(seqg_env, 6/*ch2_ps_on_off_sts*/, DEFAULT, DEFAULT_TIMEOUT);
# line 118 "../ch2_fsm.st"
			sprintf(seqg_var->Chan2_seq_messages, "Try Again");
# line 119 "../ch2_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan2_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
		}
		return;
...
static void seqg_action_OFF_ON_FSM_0_DONE(SS_ID seqg_env, int seqg_trn, int *seqg_pnst)
{
	...
	case 0:
		{
# line 124 "../ch2_fsm.st"
			sprintf(seqg_var->Chan2_seq_messages, "PS Ready");
# line 125 "../ch2_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan2_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
# line 126 "../ch2_fsm.st"
			seqg_var->ch2_ps_on_off_sts = 1;
...
# line 134 "../ch2_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan2_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
# line 135 "../ch2_fsm.st"
			seqg_var->ch2_dac_setpoint = 0.00;
# line 136 "../ch2_fsm.st"
			seq_pvPutTmo(seqg_env, 2/*ch2_dac_setpoint*/, DEFAULT, DEFAULT_TIMEOUT);
# line 137 "../ch2_fsm.st"
			seqg_var->ch2_ps_on_off_sts = 0;
...
static void seqg_action_OFF_ON_FSM_0_SET_DAC_TO_ZERO_OFF(SS_ID seqg_env, int seqg_trn, int *seqg_pnst)
{
	...
	case 0:
		{
# line 148 "../ch2_fsm.st"
			sprintf(seqg_var->Chan2_seq_messages, "Pls Wait");
# line 149 "../ch2_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan2_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
		}
		return;
...
static void seqg_action_OFF_ON_FSM_0_POWER_OFF(SS_ID seqg_env, int seqg_trn, int *seqg_pnst)
{
	...
	case 0:
		{
# line 154 "../ch2_fsm.st"
			sprintf(seqg_var->Chan2_seq_messages, "Pwr OFF");
# line 155 "../ch2_fsm.st"
			seq_pvPutTmo(seqg_env, 9/*Chan2_seq_messages*/, DEFAULT, DEFAULT_TIMEOUT);
# line 156 "../ch2_fsm.st"
			seqg_var->on1_cmd = 0;
...
static seqChan seqg_chans[] = {
	...
	{"{M1}I-sp", offsetof(struct seqg_vars, ch2_dac_setpoint), "ch2_dac_setpoint", P_SHORT, 1, 3, 0, 1, 0, 0},
	{"{M0}:On1-Cmd", offsetof(struct seqg_vars, on1_cmd), "on1_cmd", P_SHORT, 1, 4, 0, 1, 0, 0},
	{"{M2}FltClearChan2-bo", offsetof(struct seqg_vars, ch2_clr_flts), "ch2_clr_flts", P_SHORT, 1, 5, 0, 1, 0, 0},
	{"{M1}Mode-cmd", offsetof(struct seqg_vars, ch2_mode), "ch2_mode", P_SHORT, 1, 6, 0, 1, 0, 0},
	{"{M0}:PsOnOff-Sts", offsetof(struct seqg_vars, ch2_ps_on_off_sts), "ch2_ps_on_off_sts", P_SHORT, 1, 7, 0, 1, 0, 0},
	{"{M0}-DAC-SP", offsetof(struct seqg_vars, ch2_dac_rdbck), "ch2_dac_rdbck", P_SHORT, 1, 8, 0, 1, 0, 0},
	{"{M0}:Status0", offsetof(struct seqg_vars, ch2_ps_sts), "ch2_ps_sts", P_SHORT, 1, 9, 0, 1, 0, 0},
	{"Chan2_seq_messages", offsetof(struct seqg_vars, Chan2_seq_messages), "Chan2_seq_messages", P_STRING, 1, 10, 0, 0, 0, 0},
};
...
seqProgram ch2_fsm = {
	...
	/* program name */      "ch2_fsm",
	/* channels */          seqg_chans,
	/* num. channels */     10,
	/* state sets */        seqg_statesets,
	/* num. state sets */   1,
	/* user var size */     sizeof(struct seqg_vars),
	/* param */             "M0=SR:C04-MG{zPSC1}Chan2,M1=SR:C04-MG{zPSC1:Chan2}, M2=SR:C04-MG{zPSC1}",
	/* num. event flags */  0,
...
static void ch2_fsmRegistrar (void) {
    seqRegisterSequencerCommands();
    seqRegisterSequencerProgram (&ch2_fsm);
}
epicsExportRegistrar(ch2_fsmRegistrar);
